		...
		<div class="main home-page">
				...
				<div class="container">
					<div class="box-top">
						<div class="nav">
							<ul>
								<div class="title">
								<li><a href="">Vaccine-Tiêm chủng</a></li>
								</div>
							</ul>
                        </div>
                    </div>
			...
			<div class="focus">
				<div class="container">
					<div class="content">
            <div class="content-l">
                <img src="https://covid19.qltns.mediacdn.vn/thumb_w/740/354844073405468672/2021/11/23/avatar1637678060235-1637678060866349772949-0-41-315-545-crop-16376787256401632466793.jpeg" alt="">
                <div class="text-content">
                    <h3>
                        Hơn 33.600 trẻ em ở Hà Nội được tiêm vaccine COVID-19
                    </h3>
                    <br>
                    <p>33.618 mũi vaccine Pfizer đã được tiêm cho học sinh lớp 10, 11, 12 ở 13 quận/huyện/thị xã trong ngày 23/11. Hà Nội là một trong 27 tỉnh, thành đã và đang triển khai tiêm vaccine COVID-19 cho trẻ.</p>
                </div>
            </div>
            <div class="content-r">
                <div class="title">
