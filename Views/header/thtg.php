		...
		<div class="main home-page">
				...
				<div class="container">
					<div class="box-top">
						<div class="nav">
							<ul>
								<div class="title">
								<li><a href="">Tình hình thế giới</a></li>
								</div>
							</ul>
                        </div>
                    </div>
			...
			<div class="focus">
				<div class="container">
					<div class="content">
            <div class="content-l">
                <img src="https://covid19.qltns.mediacdn.vn/thumb_w/740/354844073405468672/2021/11/24/avatar1637739802156-1637739802397826303745-0-0-416-665-crop-16377398084821542401071.jpg" alt="">
                <div class="text-content">
                    <h3>
                    Giới chuyên gia cảnh báo nguy cơ làn sóng dịch COVID-19 lần thứ tư tại Malaysia
                    </h3>
                    <br>
                    <p>Khi tỷ lệ tiêm vaccine ngừa COVID-19 tăng cao, số ca mắc mới COVID-19 sẽ giảm mạnh. Tuy nhiên, sau thời gian từ 3-6 tháng khi khả năng miễn dịch do vaccine tạo ra giảm, số ca nhiễm mới sẽ tăng trở lại theo đồ thị hình chữ U. Đây là nhận xét chung của các chuyên gia y tế Malaysia ở thời điểm hiện tại..</p>
                </div>
            </div>
            <div class="content-r">
                <div class="title">
