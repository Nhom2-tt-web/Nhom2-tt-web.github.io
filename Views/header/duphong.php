		...
		<div class="main home-page">
				...
				<div class="container">
					<div class="box-top">
						<div class="nav">
							<ul>
								<div class="title">
								<li><a href="">Dự phòng - Điều trị</a></li>
								</div>
							</ul>
                        </div>
                    </div>
			...
			<div class="focus">
				<div class="container">
					<div class="content">
            <div class="content-l">
                <img src="https://covid19.qltns.mediacdn.vn/thumb_w/740/354844073405468672/2021/11/24/avatar1637739365428-16377393660621005339782.jpg" alt="">
                <div class="text-content">
                    <h3>
                    Bến Tre thực hiện quản lý, chăm sóc người nhiễm Covid-19 tại nhà
                    </h3>
                    <br>
                    <p>SKĐS - Bản tin dịch COVID-19 ngày 18/10 của Bộ Y tế cho biết có 3.168 ca mắc COVID-19 tại 45 tỉnh, thành phố, trong đó TP HCM là 968 ca, Sóc Trăng 174 ca. Trong ngày có 1.136 bệnh nhân khỏi; 75 ca tử vong.</p>
                </div>
            </div>
            <div class="content-r">
                <div class="title">
