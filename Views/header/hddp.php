		...
		<div class="main home-page">
				...
				<div class="container">
					<div class="box-top">
						<div class="nav">
							<ul>
								<div class="title">
								<li><a href="">Hoạt động địa phương</a></li>
								</div>
							</ul>
                        </div>
                    </div>
			...
			<div class="focus">
				<div class="container">
					<div class="content">
            <div class="content-l">
                <img src="https://covid19.qltns.mediacdn.vn/thumb_w/740/354844073405468672/2021/11/24/avatar1637739505743-1637739506273620173737-38-0-454-665-crop-16377395148511231174420.jpg" alt="">
                <div class="text-content">
                    <h3>
                    Cao Bằng thực hiện nhiều biện pháp khẩn cấp phòng, chống dịch COVID-19
                    </h3>
                    <br>
                    <p>Trong ngày 23 và sáng 24/11, tỉnh Cao Bằng ghi nhận 11 trường hợp dương tính SARS-CoV-2 trong cộng đồng</p>
                </div>
            </div>
            <div class="content-r">
                <div class="title">
